...
graph TD
    ...
    click B "./src/cli/AGENTS.md" "查看 CLI 模块文档"
    click C "./src/scanner/AGENTS.md" "查看 Scanner 模块文档"
    click D "./src/analyzer/AGENTS.md" "查看 Analyzer 模块文档"
    click E "./src/reporter/AGENTS.md" "查看 Reporter 模块文档"
    click F "./src/types/AGENTS.md" "查看 Types 模块文档"
    click G "./src/analyzer/advanced/AGENTS.md" "查看 Advanced 模块文档"
```
